...
class EditDataFieldDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, dtmService: ghidra.app.services.DataTypeManagerService, location: ghidra.program.util.ProgramLocation, dataTypeComponent: ghidra.program.model.data.DataTypeComponent):
        """
        Constructor
        ...
        :param ghidra.program.util.ProgramLocation location: the location of the field being edited
        :param ghidra.program.model.data.DataTypeComponent dataTypeComponent: the component of the field being edited
        """
...
class DataPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.DataService):
    ...
    def pickDataType(self) -> ghidra.program.model.data.DataType:
        ...
